...
import gameplayelements.CommandRun;
...
public final class StartGameInput {
    ...
    /**
     * Increments the numberOfTurns field.
     */
    ...
    public void setDeck1(final ArrayList<CardInput> deck1) {
        this.deck1 = deck1;
    }
    ...
    public void setDeck2(final ArrayList<CardInput> deck2) {
        this.deck2 = deck2;
    }
     ...
     */
    public void start(final Input input, final ArrayNode output, final GameInput game) {
